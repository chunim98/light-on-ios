...
final class CounterTextForm: NTextForm {
    ...
    override func setStyle(phase: FormPhase) {
        ...
        switch phase {
        case .idle:    byteLabel.config.foregroundColor = .caption
        case .focused:  byteLabel.config.foregroundColor = .caption
        case .filled:   byteLabel.config.foregroundColor = .caption
        case .error:  byteLabel.config.foregroundColor = .destructive
        }
    }
}
...
extension CounterTextForm {
    ...
    private func bindState(state: CounterTextFormState) {
        ...
        setStyle(phase: state.styleFlag)
    }
