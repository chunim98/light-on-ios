//
//  MyRegistrationRequestedVC.swift
//  LightOn
//
...
final class MyRegistrationRequestedVC: CombineVC {
    ...
    private let vm = MyActivityHistoryDI.shared.makeMyRegistrationRequestedVM()
    ...
    private func setupDefaults() { titleLabel.config.text = "나의 공연" }
