...
final class LargePerformanceCell: UICollectionViewCell {
    
    // MARK: Properties
    
    static let id = "LargePerformanceCell"
    ...
    func configure(item: LargePerformanceCellItem?) {
