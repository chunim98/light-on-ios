...
final class HomeSpotlightedVC: CombineVC {
    
    // MARK: Properties
    
    private var cancellables = Set<AnyCancellable>()
    private let vm = HomeDI.shared.makeHomeSpotlightedVM()
    ...
    private let collectionView = MediumPerformanceCollectionView()
    ...
    private func setupBindings() {
        let input = HomeSpotlightedVM.Input(trigger: viewDidAppearPublisher)
